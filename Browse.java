...
public class Browse{
  ...
  */
    public Browse(String fileName,String filePath,String preLocation){
    try{
   ...
   /*
   * This method assist Browse constructor in moving bytes from source file into target file
